...
public class PerlinNoiseBiome : MonoBehaviour
{
    public int width = 64;
    ...
    void Start()
    {
        Telemetry.Instance?.RecordGenerationStart("PerlinNoiseLevelPart");
        Generate();
        Telemetry.Instance?.RecordGenerationEnd("PerlinNoiseLevelPart");
    }
